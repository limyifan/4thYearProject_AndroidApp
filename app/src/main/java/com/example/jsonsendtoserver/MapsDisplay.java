...
//        PolylineOptions lineOptions = new PolylineOptions().addAll(latLngs).color(Color.BLUE).width(5);
//
//        if(lineOptions != null) {
...
//        }
        ...
        String destination = latLngs.get(1).latitude+","+latLngs.get(1).longitude;
